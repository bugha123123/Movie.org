...
namespace CinemaClix.Migrations
{
    ...
    [Migration("20240306112604_addingSenderIdToPrivateChat")]
    partial class addingSenderIdToPrivateChat
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CinemaClix.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "$2a$11$2VgDa.2DV.HcHPl/oH2whexSMZHS1EbAIgGfr/A5HrxDX8DJGPSSG",
                            Role = "Admin",
                            Suspended = false,
                            UserName = "admin"
                        });
            ...
            modelBuilder.Entity("CinemaClix.Models.WatchListedShow", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CinemaClix.Models.LikedShows", b =>
                {
                    b.HasOne("CinemaClix.Models.Show", "Show")
                        .WithMany()
