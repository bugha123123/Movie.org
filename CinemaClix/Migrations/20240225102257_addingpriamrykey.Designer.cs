...
namespace CinemaClix.Migrations
{
    ...
    [Migration("20240225102257_addingpriamrykey")]
    partial class addingpriamrykey
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CinemaClix.Models.MovieUserWatchList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CinemaClix.Models.MovieUserWatchList", b =>
                {
                    b.HasOne("CinemaClix.Models.Movie", "Movie")
                        .WithMany("MovieUserWatchLists")
                        .HasForeignKey("MovieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CinemaClix.Models.UserWatchList", "UserWatchList")
                        .WithMany("MovieUserWatchLists")
            ...
            modelBuilder.Entity("CinemaClix.Models.Movie", b =>
                {
                    b.Navigation("MovieUserWatchLists");
                });
